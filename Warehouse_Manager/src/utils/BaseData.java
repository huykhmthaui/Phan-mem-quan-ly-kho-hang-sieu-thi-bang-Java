...
public class BaseData {
	...
	public static Product generateProduct() {
		...
		String[] productNames = { "Coca", "Pepsi", "Đũa gỗ", "Xà phòng Lifebouy", "Fanta", "Sprite",
				"Xúc xích Ponny", "Snack bò lúc lắc", "Snack cay", "Snack dừa", "Snack bí đỏ", "Snack bắp",
				"Xúc xích 3 bông mai", "Sữa Milo", "Teaplus Oolong", "Teaplus trà chanh", "Trà chanh 0 độ",
				"Sữa cam", "Sữa TH", "Bánh mì bơ", "Snack tôm cay", "Sữa dâu", "Mì Idomie",
				"Mì tôm Hảo Hảo", "Bò húc" };
